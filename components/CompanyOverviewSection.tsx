      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center">
          <div className="card-glow p-12 max-w-4xl mx-auto relative overflow-hidden">
            ...
            {/* Floating Elements */}
            <div className="absolute top-4 right-4 w-16 h-16 bg-primary-500/20 rounded-full animate-float floating-light"></div>
            <div className="absolute bottom-4 left-4 w-12 h-12 bg-secondary-500/20 rounded-full animate-float floating-light" style={{ animationDelay: '2s' }}></div>
          </div>
        </div>
      </div>
    </section>
