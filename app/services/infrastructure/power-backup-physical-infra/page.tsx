      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
            ...
            <span>/</span>
            <Link href="/services/infrastructure" className="hover:text-primary-500 transition-colors">Infrastructure</Link>
            <span>/</span>
            <span className="text-gray-900">Power Backup & Physical Infra</span>
          </div>
